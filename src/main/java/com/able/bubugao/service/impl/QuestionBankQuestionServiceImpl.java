...
import com.able.bubugao.service.QuestionBankService;
import com.able.bubugao.service.QuestionService;
...
import com.able.bubugao.exception.ThrowUtils;
import com.able.bubugao.mapper.QuestionBankQuestionMapper;
...
import com.able.bubugao.service.QuestionBankQuestionService;
...
public class QuestionBankQuestionServiceImpl extends ServiceImpl<QuestionBankQuestionMapper, QuestionBankQuestion> implements QuestionBankQuestionService {
    ...
    public void validQuestionBankQuestion(QuestionBankQuestion questionBankQuestion, boolean add) {
        ...
        if (questionBankId != null) {
            QuestionBank questionBankServiceById = questionBankService.getById(questionBankId);
            ThrowUtils.throwIf(questionBankServiceById == null, ErrorCode.NOT_FOUND_ERROR);
        }
        Long questionId = questionBankQuestion.getQuestionId();
        if (questionId != null) {
            Question questionServiceById = questionService.getById(questionId);
            ThrowUtils.throwIf(questionServiceById == null, ErrorCode.NOT_FOUND_ERROR);
     ...
     */
    @Override
    public void batchQuestionBankQuestionVoAdd(List<Long> questionIdList, Long questionBankId, User loginUser) {
        // 参数校验
        ...
        for (int i = 0; i < totalQuestionListSize; i += batchSize) {
            ...
            CompletableFuture<Void> future = CompletableFuture.runAsync(() -> {
                questionBankQuestionService.batchQuestionBankQuestionVoAdd(questionBankQuestions);
            }, customExecutor);
            futures.add(future);
        }
        // 等待所有批次完成操作
    ...
    public void batchQuestionBankQuestionVoAdd(List<QuestionBankQuestion> questionBankQuestions) {
        try {
     ...
     */
    @Override
    public void batchQuestionBankQuestionVoRemove(List<Long> questionIDList, Long questionBankId) {
        //校验
        ThrowUtils.throwIf(CollUtil.isEmpty(questionIDList),ErrorCode.PARAMS_ERROR,"题目列表不能为空");
